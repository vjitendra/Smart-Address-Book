...
public class DatabaseHelper extends SQLiteOpenHelper 
{
	...
	static final String dbName="my_db13";
	...
	{	db.execSQL("CREATE TABLE "+calllistTable+" ("+callid+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+colclname+ " TEXT)");
		db.execSQL("CREATE TABLE "+locationTable+" ("+collocid+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+collocname+ " TEXT,"+collocaddr+ " TEXT)");
		db.execSQL("CREATE TABLE "+contactTable+" ("+colconid+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+colconname+ " TEXT,"+colconnum+ " TEXT)");
		/*db.execSQL("CREATE TABLE "+taskTable+" ("+colid +" INTEGER PRIMARY KEY AUTOINCREMENT, "+colname+" TEXT, "
	...
	int getTaskCnt()
	 ...
	 public Cursor gettask_today(String sdate)
	 {
	 ...
	 /*void Inserttask(String tname,String tdesp,int type,String pr,int cat,String sdate,String date,String time,int cid,int lid)
	 {	 
		 SQLiteDatabase db= this.getWritableDatabase();
		 ContentValues cv=new ContentValues();
	 ...
	 public void Inserttask(String towner,String tname,String tdesp,int type,String pr,int cat,String sdate,String date,String time,int cid,int lid)
		{	 
			SQLiteDatabase db= this.getWritableDatabase();
			ContentValues cv=new ContentValues();
